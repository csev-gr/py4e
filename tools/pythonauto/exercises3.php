...
"!45" => "Πρέπει να διαβάσετε από το πληκτρολόγιο τα δεδομένα χρησιμοποιώντας την input() και στη συνέχεια να τα μετατρέψετε στον κατάλληλο τύπο. Το νούμερο '45' δεν πρέπει να περιέχεται στο πρόγραμμά σας.",
"!10.5" => "Πρέπει να διαβάσετε από το πληκτρολόγιο τα δεδομένα χρησιμοποιώντας την input() και στη συνέχεια να τα μετατρέψετε στον κατάλληλο τύπο. Το νούμερο '10.5' δεν πρέπει να περιέχεται στο πρόγραμμά σας.",
"if" => "Πρέπει να χρησιμοποιήσετε μια εντολή if για να αποφασίσετε αν θα υπολογίσετε υπερωρίες ή όχι.",
"float" => "Πρέπει να χρησιμοποιήσετε την ενσωματωμένη συνάρτηση float() για να μετατρέψετε τη συμβολοσειρά σε float.",
"def" => "Πρέπει να χρησιμοποιήσετε μια συνάρτηση με όνομα computepay για να υλοποιήσετε τον υπολογισμό.",
"!sum(" => "Μην χρησιμοποιείτε το sum ως όνομα μεταβλητής ή συνάρτησης",
"return" => "Πρέπει να χρησιμοποιήσετε μια δήλωση return για να επιστρέψετε τον υπολογισμένο μισθό πίσω στο κυρίως πρόγραμμα.",
"computepay" => "Πρέπει να χρησιμοποιήσετε μια συνάρτηση με το όνομα computepay για να υλοποιήσετε τον υπολογισμό.",
